...
/*func UserAgent2String(b []byte) string {
	return Byte2String(b)[1:] //strip off that first 0x0f
}

//Convert a string to UserAgent
func String2UserAgent(s string) []byte {
	return String2Byte("\u000f" + s) //why is there the SHIFT-IN (0x0f) character at the beginning? don't know.
}*/
